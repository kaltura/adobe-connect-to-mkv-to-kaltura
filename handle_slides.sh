...
I=0;while read SCENE_TIME ;do 
    echo $OUTDIR/imgs/$MEETING_ID/${I}_${SCENE_TIME}.jpg;ffmpeg -nostdin -ss "$SCENE_TIME" -i $OUTDIR/$MEETING_ID.full.mkv -vframes 1 -q:v 2 -y $OUTDIR/imgs/$MEETING_ID/${I}_${SCENE_TIME}.jpg 2>/tmp/log;I=`expr $I + 1`;
